<%@ Page Title="" Language="C#" MasterPageFile="~/Lean.Master" AutoEventWireup="true" CodeBehind="SpecialBidMassUpload.aspx.cs" Inherits="LeanWeb.role_DefineParameters.SpecialBidMassUpload" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="server">
    <h3>Mass Update Active SCV</h3>
            ...
            <tbody>
                ...
                <tr>
                    <td class="padding-top-small" colspan="3">
                        <asp:LinkButton ID="LinkButton1" runat="server" href="\LeanApplication\LeanWeb\role_DefineParameters\Templates\Special_Bid_Mass_Upload.xlsx">Click Here To Download The Latest Template</asp:LinkButton>
                    </td>
                </tr>
            </tbody>
        </table>
