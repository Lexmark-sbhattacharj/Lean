<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sites.aspx.cs" Inherits="LeanWeb.Sites" %>
                                        ...
                                        <div class="sign-in l-pad-thick bg--n1">
                                            ...
                                            <div class="info-wrapper">
                                                ...
                                                <div class="form__field">
                                                    ...
                                                    <asp:DropDownList ID="ddlSite" runat="server" OnSelectedIndexChanged="ddlSite_SelectedIndexChanged"  />
                                                </div>
