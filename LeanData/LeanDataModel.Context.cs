...
namespace LeanData
{
    ...
    public partial class LeanDataModelContainer : DbContext
    {
        public LeanDataModelContainer()
            : base("name=LeanDataModelContainer")
        {
        }
        ...
        public virtual int sp_GenReportPullbyDate(string platform, Nullable<System.DateTime> from, Nullable<System.DateTime> to, Nullable<int> type, string leanApp)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_GenReportPullbyDate", platformParameter, fromParameter, toParameter, typeParameter, leanAppParameter);
        }
    
        [EdmFunction("LeanDataModelContainer", "Split")]
        public virtual IQueryable<string> Split(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[LeanDataModelContainer].[Split](@String, @Delimiter)", stringParameter, delimiterParameter);
        }
    
        public virtual ObjectResult<TEST_Line_Result> TEST_Line(Nullable<int> lineID)
        {
            var lineIDParameter = lineID.HasValue ?
                new ObjectParameter("LineID", lineID) :
                new ObjectParameter("LineID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TEST_Line_Result>("TEST_Line", lineIDParameter);
        }
        ...
        public virtual int UPDATE_SPECIAL_BIDS(string idLocalization, string idMaterial, Nullable<int> quantity, string uploadUser, string comments, string lean_App, Nullable<int> original_idSpecialBid)
        {
            var idLocalizationParameter = idLocalization != null ?
                new ObjectParameter("idLocalization", idLocalization) :
                new ObjectParameter("idLocalization", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UPDATE_SPECIAL_BIDS", idLocalizationParameter, idMaterialParameter, quantityParameter, uploadUserParameter, commentsParameter, lean_AppParameter, original_idSpecialBidParameter);
        }
        ...
        public virtual ObjectResult<string> GETIDMATERIALVKBINPUT(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GETIDMATERIALVKBINPUT", lean_AppParameter);
        }
    
        public virtual ObjectResult<string> GETLOCALIZATIONVKBINPUT(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GETLOCALIZATIONVKBINPUT", lean_AppParameter);
        }
    
        public virtual ObjectResult<string> GETIDMATERIALVKBINPUT1(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GETIDMATERIALVKBINPUT1", lean_AppParameter);
        }
    
        public virtual ObjectResult<GET_IDMATERIAL_VKBINPUT_Result> GET_IDMATERIAL_VKBINPUT(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_IDMATERIAL_VKBINPUT_Result>("GET_IDMATERIAL_VKBINPUT", lean_AppParameter);
        }
    
        public virtual ObjectResult<GET_LOCALIZATION_VKBINPUT_Result> GET_LOCALIZATION_VKBINPUT(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_LOCALIZATION_VKBINPUT_Result>("GET_LOCALIZATION_VKBINPUT", lean_AppParameter);
        }
        ...
        public virtual ObjectResult<GET_MATERIAL_VKB_Detail_PartNumber_PROD_PRIORITY_Result> GET_MATERIAL_VKB_Detail_PartNumber_PROD_PRIORITY(string material, string leanApp)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_MATERIAL_VKB_Detail_PartNumber_PROD_PRIORITY_Result>("GET_MATERIAL_VKB_Detail_PartNumber_PROD_PRIORITY", materialParameter, leanAppParameter);
        }
        ...
        public virtual ObjectResult<GET_VKB_DETAILS_Result> GET_VKB_DETAILS(string lean_Application, string line, Nullable<bool> iS_CHECKED, Nullable<System.DateTime> date, string filter)
        {
            var lean_ApplicationParameter = lean_Application != null ?
                new ObjectParameter("Lean_Application", lean_Application) :
                new ObjectParameter("Lean_Application", typeof(string));
            ...
            var iS_CHECKEDParameter = iS_CHECKED.HasValue ?
                ...
                new ObjectParameter("IS_CHECKED", typeof(bool));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_VKB_DETAILS_Result>("GET_VKB_DETAILS", lean_ApplicationParameter, lineParameter, iS_CHECKEDParameter, dateParameter, filterParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> GET_IS_CHECKED(string userName, string lean_App)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("GET_IS_CHECKED", userNameParameter, lean_AppParameter);
        }
        ...
        public virtual ObjectResult<PARTNO_WEEKSDEMAND_DISTRIBUTIONEXCEP_Result> PARTNO_WEEKSDEMAND_DISTRIBUTIONEXCEP(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PARTNO_WEEKSDEMAND_DISTRIBUTIONEXCEP_Result>("PARTNO_WEEKSDEMAND_DISTRIBUTIONEXCEP", lean_AppParameter);
        }
    
        public virtual ObjectResult<PARTNO_WEEKSDEMAND_DISTRIBUTIONNETWORK_Result> PARTNO_WEEKSDEMAND_DISTRIBUTIONNETWORK(string lean_App)
        {
            var lean_AppParameter = lean_App != null ?
                new ObjectParameter("Lean_App", lean_App) :
                new ObjectParameter("Lean_App", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PARTNO_WEEKSDEMAND_DISTRIBUTIONNETWORK_Result>("PARTNO_WEEKSDEMAND_DISTRIBUTIONNETWORK", lean_AppParameter);
        }
